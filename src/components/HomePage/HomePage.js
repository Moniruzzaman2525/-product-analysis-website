        ...
        <div>
            <div className='grid grid-cols-1 md:grid-cols-2 py-8 px-8'>
                <div className='order-2 mt-8 md:order-1 flex flex-col justify-center items-center'>
                    ...
                    <p className='text-2xl'>At WatchShop, you can guarantee you will find more watch brands than anywhere else. From the biggest designer brands, to the best of luxury and some hidden gems, along with outstanding service and next day delivery, WatchShop is the hottest place to buy your next watch.
                    </p>
                </div>
